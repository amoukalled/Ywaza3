...
public class TeamSQLiteOpenHelper extends SQLiteOpenHelper
{
    ...
    public TeamSQLiteOpenHelper(Context context) { super(context,DB_NAME,null, DB_VERSION);}
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insertTeam(db, 1,"Manchester United",4, R.drawable.ManUnited);
